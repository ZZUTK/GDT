function [ accuracy, stderror ] = DT_CrossValidation( X, Y, leave, iter)
% cross validation using decisoin tree
%
% Input:
...
for loop = 1:iter
    ...
    % training
    T = fitctree(train_x, train_y);
    
    % testing
    y_hat = [ y_hat , predict(T, test_x) ];
